...
#include <nlohmann/json.hpp>
	...
	namespace gbm2gc
	{
		...
		public:
			 ...
			 */
            html::variant operator()(const nlohmann::json& benchmark) const;
		...
		public:
			...
			const html::googlechart_dom_options& dom_options() const;
			const html::googlechart_options& chart_options() const;
			const html::googlechart::visualization chart_type() const;
		...
		private:
            ...
            html::googlechart_options gc_options_;
            html::googlechart_dom_options gc_dom_options_;
            html::googlechart::visualization gc_type_;
		 ...
		 */
        html::data_set parse_data(const options& options, const nlohmann::json& bm_result);

		void write_chart(const options& options, const html::data_set& data_set);
